...
lista_privilegios_admin = ['puede añadir comentario', 'puede borrar comentario', 'puede vetar usuarios']

class Privilegios:
    def __init__(self, privilegios=lista_privilegios_admin):
        self.privilegios = privilegios

    def show_privileges(self):
        print('Los privilegios del administrador son los siguientes: ')
...
mi_usuario.privilegios.show_privileges()
